...
class TestConsole(unittest.TestCase):
    ...
    @classmethod
    def teardown(cls):
        """This will tear down the testwhen it ends"""
        del cls.consol
    ...
    def test_pep8_console(self):
        """This tests for Pep8 console.py"""
        style = pep8.StyleGuide(quiet=True)
        p = style.check_files(["console.py"])
        self.assertEqual(p.total_errors, 0, 'fix Pep8')

    def test_docstrings_in_console(self):
        """This tests if docstrings are properly set"""
    ...
    def test_emptyline(self):
        """Tests the empty line input"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("\n")
            self.assertEqual('', f.getvalue())

    def test_quit(self):
        """Tests if quit command input works"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("quit")
            self.assertEqual('', f.getvalue())

    def test_create(self):
        """Tests if create command input works"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_show(self):
        """Tests show command input and output"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """Tests if destroy command input works"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_all(self):
        """Test the alternate all command input"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_show(self):
        """Test the alternate show command input"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_destroy(self):
        """Test the alternate destroy command input"""
        with patch('sys.stdout', new=StringIO()) as f:
